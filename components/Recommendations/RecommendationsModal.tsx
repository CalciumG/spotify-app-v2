      ...
      >
        ...
        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center">
          <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all">
            ...
            <button
              type="button"
              className="flex justify-center w-full shadow-sm p-4 bg-green-600 text-base font-medium text-white hover:bg-green-700 focus:outline-none focus:bg-green-700 sm:text-sm"
              onClick={() => {
            ...
            <button
              type="button"
              className="w-full flex justify-center shadow-sm p-4 bg-white text-base font-medium text-gray-700 focus:outline-none focus:bg-gray-200 hover:bg-gray-50 sm:text-sm"
              onClick={() => setOpen(false)}
              ref={cancelButtonRef}
            >
              Close
